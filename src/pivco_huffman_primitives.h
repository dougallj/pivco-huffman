 ...
 *    bitmap-build step.  No node_type maps to it anymore (the former
 *    BOTH_LEAVES pair is a D=1 flat region on the no-pair branch); it
 *    survives as the D=1 body of prim_enc_pack_dN and for bench_prim.
 *
